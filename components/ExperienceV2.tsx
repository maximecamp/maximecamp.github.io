      ...
      <div className="space-y-1">
        {items.map((item, index) => {
          ...
          <article
            ...
            className={`group relative p-5 rounded-2xl bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-300 ease-in-out flex flex-col sm:flex-row items-start sm:items-center gap-6 ${item.block_type === "item" ? "ml-8 sm:ml-12" : ""} ${hasDescription ? 'cursor-pointer hover:bg-blue-50/[.65] dark:hover:bg-gray-800/[.65] active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:focus-visible:ring-blue-400' : ''}`}
          >
